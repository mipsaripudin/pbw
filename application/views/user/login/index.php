                                            ...
                                            <div class="auth-content card-body p-5 h-100 text-white">
                                                <div class="w-100">
                                                    <div class="text-center mb-4">
                                                        <h5>MASUK</h5>
                                                        <p class="text-white-70">SILAHKAN MASUK UNTUK CEK GAJI ANDA</p>
                                                    </div>
                                                    <?= $this->session->flashdata('message') ?>
                                                    <form action="<?= site_url('auth') ?>" method="post" class="auth-form">
                                                        <div class="mb-3">
                                                            <label for="usernameInput" class="form-label">Username</label>
                                                            <input type="text" class="form-control" name="username" id="usernameInput" placeholder="Masukkan Username Anda" required>
                                                        </div>
                                                        <div class="mb-3">
                                                    ...
                                                    <div class="mt-4 text-center">
                                                        <p class="mb-0">Jika terkendala silahkan hubungi <a href="#" class="fw-medium text-white text-decoration-underline">Admin</a></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
